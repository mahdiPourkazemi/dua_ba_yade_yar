...
fun LazyTextLayout(
    ...
    // Use TextMeasurer for measuring without UI rendering
    val textMeasurer = rememberTextMeasurer()

    val layoutResult = textMeasurer.measure(
        text = text,
        style = textStyle,
        constraints = cons//Constraints.fixedWidth(textWidth)//fitPrioritizingWidth( )//
    )
    ...
    // Create the lazy layout with LazyColumn for scrolling
...
/**
 * Extract text between startLine (inclusive) and endLine (exclusive).
 */
